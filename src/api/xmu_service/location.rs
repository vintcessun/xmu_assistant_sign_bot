...
pub static LOCATIONS: LazyLock<LocationService> = LazyLock::new(|| {
    LocationService::new([
        ...
        Location::new(Region::SiMing, "祖营楼", 118.097_046, 24.436_758),
        Location::new(Region::XiangAn, "图书馆香山", 118.311_424, 24.605_495),
        Location::new(Region::SiMing, "钟铭选楼", 118.093_864, 24.436_96),
        Location::new(Region::SiMing, "联兴楼", 118.099_44, 24.434_107),
        Location::new(Region::XiangAn, "希平楼", 118.317_6, 24.605_528),
        Location::new(Region::SiMing, "艺术学院", 118.109_67, 24.430_94),
        Location::new(Region::XiangAn, "金泉楼", 118.315_56, 24.606_601),
        Location::new(Region::SiMing, "基金楼", 118.095_78, 24.437_609),
        Location::new(Region::SiMing, "群贤二", 118.095_6, 24.437_1),
        Location::new(Region::SiMing, "德贞楼", 118.101_67, 24.433_97),
    ])
});
